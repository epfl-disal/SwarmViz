START_DIR = /home/jornod/visualpso/project/swarmvisualiser/sammon

MATLAB_ROOT = /enacit1/opt/matlab/R2013a
MAKEFILE = sammon_mex.mk

include sammon_mex.mki
...
MEX_FILE_NAME_WO_EXT = sammon_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/sammon"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/sammon/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/sammon/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/sammon/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
